...
public class ActivitySetting extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        devPref.setOnPreferenceClickListener(preference -> {
            Tools.directLinkToBrowser(ActivitySetting.this, AppConfig.general.contact_us_url);
            return false;
        });

        morePref.setOnPreferenceClickListener(preference -> {
            Tools.directLinkToBrowser(ActivitySetting.this, AppConfig.general.more_apps_url);
            return true;
        });
